    ...
    <section id="skills" className="section-padding" style={{ background: 'var(--bg-secondary)' }}>
      <div className="container">
        <div className="section-header" style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.98rem', marginTop: '0.5rem', maxWidth: '600px', marginInline: 'auto' }}>
            Core competencies across AI engineering, visual design systems, and growth strategy.
          </p>
        </div>
